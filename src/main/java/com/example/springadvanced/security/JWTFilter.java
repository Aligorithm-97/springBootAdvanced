...
public class JWTFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private UserDetailServiceExample detailService;


    //Best practice değil tekrar bakılacak pathstocont kısmına bunun normalde securityconfiguration kısmında olması gerek şimdilik böyle
    private List<String>        pathsToCont = Arrays.asList("/sec", "/actuator", "/h2-console","/counter","/swagger-ui","/v3/api-docs");
